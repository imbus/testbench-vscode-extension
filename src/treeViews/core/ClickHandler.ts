        ...
        if (isDoubleClick) {
            ...
            if (this.handlers.onDoubleClick) {
                try {
                    ...
                    if (logger) {
                        logger.error(`[ClickHandler] Error when handling double click for item: ${itemId}`, error);
                    }
                    throw error;
                }
            }
            ...
            if (this.handlers.onSingleClick) {
                try {
                    ...
                    if (logger) {
                        logger.error(`[ClickHandler] Error when handling single click for item: ${itemId}`, error);
                    }
                    throw error;
                }
            }
