...
export class LoginWebViewProvider implements vscode.WebviewViewProvider {
    ...
    private async getLoginHtmlPage(webview: vscode.Webview): Promise<string> {
        ...
        // ${webview.cspSource} is a placeholder for VS Code's webview resource sources.
        const contentSecurityPolicy: string = `default-src 'none'; img-src ${webview.cspSource} https: data:; script-src 'unsafe-inline' ${webview.cspSource}; style-src ${webview.cspSource} 'unsafe-inline'; font-src ${webview.cspSource};`;
